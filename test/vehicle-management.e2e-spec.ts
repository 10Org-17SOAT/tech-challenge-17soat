...
import { Vehicle } from '../src/modules/onboarding/vehicle-management/domain/entities/vehicle.entity';
import type { IVehicleRepository } from '../src/modules/onboarding/vehicle-management/domain/repositories/vehicle.repository';
import {
  LicensePlate,
  VehicleId,
} from '../src/modules/onboarding/vehicle-management/domain/value-objects';
